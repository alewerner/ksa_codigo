...
public class NovoLivroRequest {
    ...
    public NovoLivroRequest(@NotBlank String resumo, @NotBlank String sumario, @NotBlank @Min(20) BigDecimal preco, @NotBlank @Min(100) Integer numeroPaginas,
    ...
    public Livro toModel(EntityManager manager) {
        ...
        return new Livro(titulo,
                resumo, sumario, preco, numeroPaginas, isbn,
